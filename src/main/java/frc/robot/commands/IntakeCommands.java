...
public class IntakeCommands extends Command {
  ...
  private final DoubleSupplier m_stopSupplier;
   ...
   */
  public IntakeCommands(IntakeSubsystem subsystem, DoubleSupplier stopSupplier) {
  ...
  public void initialize() {
    m_IntakeSubsystem.intakeSpeed(m_stopSupplier);
  }
